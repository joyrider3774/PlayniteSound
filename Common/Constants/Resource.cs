...
namespace PlayniteSounds.Common.Constants
{
    public class Resource
    {
        ...
        public static string ActionsUpdateLegacy => _actionsUpdateLegacy.Value;
        private static readonly Lazy<string> _actionsUpdateLegacy = new Lazy<string>(() => ToId("LOC_PLAYNITESOUNDS_ActionsUpdateLegacy"));
